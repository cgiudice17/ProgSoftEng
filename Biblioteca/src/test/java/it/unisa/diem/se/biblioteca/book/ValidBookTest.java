...
public class ValidBookTest implements ValidBook {
    ...
    public void testValidISBN() {
        ...
        assertFalse(validISBN("97812345678E1"), "Notazione scientifica (E) deve fallire.");
        assertFalse(validISBN("97812345678.9"), "Punto decimale deve fallire.");
    ...
    public void testValidAuthor() {
        ...
        assertFalse(validAuthor("-Rossi"), "Trattino iniziale deve fallire.");
        assertFalse(validAuthor("Rossi-"), "Trattino finale deve fallire.");
        assertFalse(validAuthor("Rossi--Bianchi"), "Doppio trattino deve fallire.");
        assertFalse(validAuthor("'Rossi"), "Apostrofo iniziale deve fallire.");
